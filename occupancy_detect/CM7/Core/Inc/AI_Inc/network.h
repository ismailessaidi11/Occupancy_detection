...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "best_augmented_tera_x4_no_time_boosted_model"
...
#define AI_NETWORK_IN_1_CHANNEL     (14)
#define AI_NETWORK_IN_1_SIZE        (14)
#define AI_NETWORK_IN_1_SIZE_BYTES  (56)
